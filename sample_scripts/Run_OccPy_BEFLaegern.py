...
overwrite = True # whether to rerun everything
cleanup = True # whether to delete contents of existing output directory

json_template = r"C:\Users\Kueken\dev\occpy_dev\OccPy\config\settings_MLS.JSON"
...
for plot in plots:
    ...
    cfg['out_dir'] = f"{plot}\\OcclusionMap_{int(parameters['vox_size']*100)}cm"
    ...
    cfg_out = f"{plot}\\OcclusionMap_{int(parameters['vox_size']*100)}cm\\config\\{plot_id}_occpy_cfg.json"
